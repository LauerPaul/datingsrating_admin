/**
*   @version 1.0 beta
*   @module @/components/animation/graphic
*   @desc <strong>Component Graphic Animation</strong>
*   @see ~/components/animation/graphic
*
...
export default {
	name: 'GraphicAnimation',
	data: data,
	computed: {
        colorLine() { if (this.color) return this.color; else return '#000'; },
	...
	* @event module:@/components/animation/graphic~COMPONENT <strong>Graphic Animation</strong> mounted
	*/
	mounted: function(){
		if (this.$store.state.Site.params.log && this.$store.state.Site.params.log.LOG_MOUNTED) this.$log.info('component \'@/components/animation/graphic\' -> mounted');		
	},
	methods: methods
}